					...
					#se procesa el dial
						if ("#{llamada.dial_number}".include? "-")
							...
							if (llamada.dial_number[0] == "0")&&(llamada.dial_number[1] == "0")
								...
								if (llamada.dial_number[1] == "2")&&(llamada.dial_number[2] == "9")&&
									(llamada.dial_number[3] == "9")

									if (llamada.dial_number[4] == "4")&&(llamada.dial_number[5] == "9")&&
											(llamada.dial_number[6] == "6")

										llamada.lugar_destino = "Cutral-Co"
										llamada.clave = 3
		


									elsif (llamada.dial_number[4] == "4")&&(llamada.dial_number[5] == "9")&&
											(llamada.dial_number[6] == "1")

										llamada.lugar_destino = "Catriel"
										llamada.clave = 3

									elsif (llamada.dial_number[4] == "4")&&(llamada.dial_number[5] == "9")&&
											(llamada.dial_number[6] == "2")

										llamada.lugar_destino = "Senillosa"
										llamada.clave = 2

									elsif (llamada.dial_number[4] == "4")&&(llamada.dial_number[5] == "9")&&
											(llamada.dial_number[6] == "3")

										llamada.lugar_destino = "Plottier"
										llamada.clave = 0
		
									elsif (llamada.dial_number[4] == "4")&&(llamada.dial_number[5] == "7")

										llamada.lugar_destino = "Cipoletti"
										llamada.clave = 0
		
									elsif (llamada.dial_number[4] == "4")&&(llamada.dial_number[5] == "9")&&
											(llamada.dial_number[6] == "8")

										llamada.lugar_destino = "Cinco Saltos"
										llamada.clave = 0

									elsif (llamada.dial_number[4] == "4")&&(llamada.dial_number[5] == "9")&&
											(llamada.dial_number[6] == "0")&&(llamada.dial_number[7] == "4")

										llamada.lugar_destino = "Anelo"
										llamada.clave = 3
									end
								...
								if (llamada.dial_number[1] == "2")&&(llamada.dial_number[2] == "9")
									...
									if (llamada.dial_number[3] == "4")&&(llamada.dial_number[4] == "1")&&(llamada.dial_number[5] == "4")

										if (llamada.dial_number[6] == "2")||(llamada.dial_number[6] == "3")||(llamada.dial_number[6] == "4")
							
											llamada.lugar_destino = "Roca"
											llamada.clave = 0

									    elsif (llamada.dial_number[6] == "5")

											llamada.lugar_destino = "Allen"
											llamada.clave = 0

										elsif (llamada.dial_number[6] == "9")&&(llamada.dial_number[7] == "1")


											llamada.lugar_destino = "Chichinales"
											llamada.clave = 0
									...
									if (llamada.dial_number[3] == "7")&&(llamada.dial_number[4] == "2")

										if (llamada.dial_number[5] == "4")&&(llamada.dial_number[6] == "2")	

											llamada.lugar_destino = "San Martin"
											llamada.clave = 0

										elsif (llamada.dial_number[5] == "4")&&(llamada.dial_number[6] == "9")	

											llamada.lugar_destino = "Junin de los Andes"
											llamada.clave = 2
